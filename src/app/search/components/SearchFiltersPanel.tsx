  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-x-4 gap-y-6 rounded-lg border border-neutral-700 bg-neutral-800/50 p-4 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <label htmlFor="filter-type" className="mb-1.5 block text-sm font-medium text-neutral-300">Тип</label>
          <Select
            value={type || "all"}
        ...
        <div>
          <label htmlFor="filter-status" className="mb-1.5 block text-sm font-medium text-neutral-300">Статус</label>
          <Select
            value={status || "all"}
        ...
        <div>
          <label htmlFor="filter-orderby" className="mb-1.5 block text-sm font-medium text-neutral-300">Сортировать по</label>
          <Select
        ...
        <div>
          <label htmlFor="filter-sort" className="mb-1.5 block text-sm font-medium text-neutral-300">Порядок</label>
          <Select
            value={sort || "desc"}
        ...
        <div className="sm:col-span-2 lg:col-span-4">
          <label className="mb-1.5 block text-sm font-medium text-neutral-300">Жанры</label>
